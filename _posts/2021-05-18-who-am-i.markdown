...
[Matomo](https://matomo.org/) looks like another cool option, but using that for free would require setting up a server, and I'm trying to keep things server-free and monetarily free for now. If enough of you start visiting my site, then Insights will become unfree, so maybe then I'll look into Matomo, but I'll stick with the free, server-less option until then.
